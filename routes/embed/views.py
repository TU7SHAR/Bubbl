...
# Marketing site — all public/marketing content lives here now.
# app.bubbl.ooo only serves the authenticated application (dashboard, bots, etc.)
...
@views_bp.route('/')
def index():
    # app.bubbl.ooo has no landing page — route users straight to the app.
...
def contact():
    # Contact form lives on the marketing site.
