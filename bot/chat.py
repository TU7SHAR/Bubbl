...
BASE_GUARDRAILS = (
    ...
    "     |----------|----------|\n"
    "     | data     | data     |\n"
    "   - Use relevant emojis sparingly to make answers friendly and scannable "
    "(e.g. a leading emoji on list items or table headers like '🚗 Model', '💰 Price'). "
    "Do not overuse them — 1 or 2 per short answer, a few in a table is plenty.\n"
